...
"Failed to upload image: {0}": "Error  al cargar imagen: {0}",
"Failed to load plugin: {0} from url {1}": "Error  al cargar complemento: {0} desde URL {1}",
"Failed to load plugin url: {0}": "Error  al cargar URL del complemento: {0}",
"Failed to initialize plugin: {0}": "Error  al iniciar el complemento: {0}",
"example": "ejemplo",
"Search": "Buscar",
"All": "Todo",
"Currency": "Divisa",
