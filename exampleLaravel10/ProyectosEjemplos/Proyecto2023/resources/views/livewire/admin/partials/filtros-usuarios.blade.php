        ...
        <div class="collapse show" id="collapseFiltrosUsuarios">
                <div class="row justify-content-between">
                    <div class="col-md-3 col-sm-6 my-1">
                        <label for="filtro_perfil" class="label-xs text-gray small m-0">Perfil:</label>
                        <ul class="nav nav-pills w-100">
                            <li class="nav-item dropdown w-100">
                                <div id="optionSelect" class="form-select filtro-select input-filter-height d-flex align-items-center ms-fs" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                                    {{ isset($filtros['perfil']['valor']) ? $filtros['perfil']['valor'] : 'Seleccione algún perfil'   }}
                                </div>
                                    ...
                                    @foreach($roles as $k=>$v)
                                        <li>
                                            <div class="d-flex flex-row">
                                                <div class="px-2">
                                                    <input wire:model="perfil" class="form-check-input" type="checkbox" id="check_perfil_{{$k}}" value="{{$k}}" />
                                                </div>
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="d-flex justify-content-between w-100 mb-1 align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    <button class="btn btn-default input-regular-height w-auto text-nowrap" wire:click="resetFiltros">Limpiar filtro</button>
                                </div>
                            </div>
                        </div>
                    @endif
