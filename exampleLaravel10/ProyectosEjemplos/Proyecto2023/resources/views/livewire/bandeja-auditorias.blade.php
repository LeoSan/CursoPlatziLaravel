<div>
    <div class="row">
        ...
        <div class="col-md-12 py-1 d-flex justify-content-end text-end align-items-center">
            <input type="text" class="form-control busqueda_casos font-regular-size bg-white input-regular-height border-filter" wire:model="busqueda" value="{{$busqueda}}" placeholder="Busque por número de auditoría">
    ...
    <div class="row d-flex justify-content-start align-items-end py-3">
        ...
        @include('livewire.partials.filtros_auditoria')
    </div>
    <div class="row">
        <div class="col-12">
