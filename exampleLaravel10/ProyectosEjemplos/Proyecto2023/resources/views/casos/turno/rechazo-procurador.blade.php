...
@section('content')
    ...
    <form action="/casos/rechazo" method="post" class="necesita-validacion" novalidate>
        <div class="mb-3">
            ...
            <input type="hidden" name="tipo_turno" value="rechazoProcurador">
                ...
                @if($usuarios)
                    <div class="form-group mb-3">
                        ...
                        <select name="usuario" id="usuario"
                                class="bg-white selectpicker-usuarios input-regular-height font-regular-size" required>
        ...
        <div class="row mt-4 justify-content-end">
            <div class="form-group col-md-3 mb-2 mb-md-0">
                <a href="/casos/{{ $caso->id }}/informacion"
                   class="btn btn-accion-detalle btn-default w-100 fw-semibold">
                    Cancelar
                </a>
            </div>
            <div class="form-group col-md-3 mb-2 mb-md-0">
                <button type="submit" class="btn btn-accion-detalle bg-estatus-{{ $estatus->codigo }} text-white w-100 fw-semibold">
