            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Le informamos que <b>la solicitud con número de oficio {{$extras['numero_oficio']}}</b> fue admitida a trámite el pasado {{$extras['fecha_solicitud']}} por lo cual el plazo legal para su atención <b>venció el {{$extras['fecha_maxima']}}</b>
                        </p>
                        <p>
                            Le invitamos a ingresar al sistema haciendo clic <a href="{{$extras['url']}}">aquí</a> para realizar las actualizaciones pertinentes para cada solicitud.
                        </p>
                        <p>
                            Saludos.
                        </p>
