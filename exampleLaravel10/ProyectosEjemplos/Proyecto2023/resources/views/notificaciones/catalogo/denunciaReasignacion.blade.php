...
<head>
    ...
    <title>Reasignación denuncia</title>
</head>
<bod>
            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Le informamos que {{$extras['usu_realizo_asig']}} le ha asignado la denuncia con Folio <b>{{$extras['folio']}} </b> {{ $extras['expediente_ati']? 'y número de expediente ATI'.$extras['expediente_ati'].'':''}}.
                        </p>
                        <p>
                            Por favor ingrese al sistema para conocer más detalle haciendo clic <a href="{{$extras['url']}}">aquí</a>.
                        </p>
                        <p>
                            Saludos.
                        </p>
