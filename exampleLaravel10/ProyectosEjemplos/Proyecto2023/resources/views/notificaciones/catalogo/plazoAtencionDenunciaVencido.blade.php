            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Le informamos que <b>la denuncia con expediente {{$extras['folio_denuncia']}}</b> fue admitida a trámite el pasado {{$extras['fecha_admicion']}} por lo cual el plazo legal para su atención <b>venció el {{$extras['fecha_maxima']}}</b>
                        </p>
                        <p>
