            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Le informamos que el caso con folio <b>{{ $extras['numero_expediente'] }}</b> y número de expediente <b>{{ $extras['numero_expediente_pgr'] }}</b> ha finalizado con estatus <b>Otro descargo</b>.
                        </p>
                        <p>
                            Haga <a href="{{ $extras['url'] }}" style="color: #67c5d7;">clic aquí</a> para ingresar al Sistema de seguimiento a casos PGR.
                        </p>
                        <p>
                            Saludos.
                        </p>
