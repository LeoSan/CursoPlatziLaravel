            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Le informamos que se ha recibido una solicitud para restablecer su contraseña, para lo cual le invitamos a que haga <a href="{{ $extras['url'] }}" style="color: #67c5d7;">clic aquí</a>.
                        </p>
                        <p>
                            Por favor considere que el link caducará en 60 minutos.
                        </p>
                        <p>
                            Si usted no realizó la petición, puede hacer caso omiso o eliminar este correo electrónico.
                        </p>
                        <p>
                            Saludos.
                        </p>
