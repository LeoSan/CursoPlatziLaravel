            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Se le informa que se ha dado respuesta a la providencia emitida el día <b>{!!$extras['fecha_emitida']!!}</b>.
                        </p>
                        <p>
                            Le invitamos a ingresar a la plataforma de Auditoría Técnica de la Inspección dando clic {!!$extras['url']!!} .
                        </p>
                        <p>
                            Saludos.
                        </p>
