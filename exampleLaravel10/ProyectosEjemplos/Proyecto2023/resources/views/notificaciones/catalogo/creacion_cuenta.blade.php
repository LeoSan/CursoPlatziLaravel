            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <br>
                        Le informamos que se ha creado una cuenta con lo siguientes datos para que pueda ingresar al <strong> {{ $extras['sistema']}}</strong>.<br><br>
                        Usuario: {{ $usuario->email}}<br>
                        Password: {{ $extras['password']}}<br><br>
                        Le recomendamos que,<strong> por seguridad</strong> proceda a realizar el 
                        <strong>cambio de su contraseña</strong> a la brevedad, ingresando a su cuenta en <a href="{{config('app.url')}}">{{config('app.url')}}</a>
                    </div>
