            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        <span style="">
                            <b>{{ $usuario->complete_name }}</b> 
                        </span>
                        <br>
                        <p>
                            Por medio de la presente se hace de su conocimiento que se ha vencido el plazo para dar respuesta al oficio <b>{{$extras['numero_oficio']}}</b> el cuál fue enviado a usted el pasado <b>{{$extras['fecha_solicitud']}}</b>.
                        </p>
                        <p>
                            Para conocer más detalle por favor ingrese al sistema haciendo clic <a href="{{$extras['url']}}">aquí</a>.
                        </p>
                        <p>
                            Saludos.
                        </p>
