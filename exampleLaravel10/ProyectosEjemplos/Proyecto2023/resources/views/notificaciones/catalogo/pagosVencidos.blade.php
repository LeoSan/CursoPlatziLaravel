            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Le informamos que los siguientes expedientes presentan uno o más <strong>pagos vencidos</strong> al <strong>{{$extras['fecha_emitida']}}</strong>:
                        </p>
                        <ul>
                            @foreach ($extras['casos'] as $i)
                                <li>{{$i->numero_expediente_pgr}}</li>
                            @endforeach
                        </ul>
                        <p>
                            Le invitamos a ingresar al sistema haciendo clic <a href="{{route('casos.index')}}">aquí</a> para realizar las actualizaciones pertinentes para cada caso.
                        </p>
                        <p>
                            Saludos.
                        </p>
