            ...
            <tr>
                <td>
                    ...
                    <div style="margin: 0 0 20px;">
                        ...
                        <br>
                        <p>
                            Por medio de la presente solicitamos su valioso apoyo para proporcionar una copia del expediente número <b>{{$extras}}</b> esto con motivo de dar pronta atención a una denuncia presentada la cual está relacionada al expediente en comento.
                        </p>
                            Agradecemos de antemano su apoyo y le invitamos a ingresar al sistema de la Auditoría Técnica de la Inspección haciendo clic <a href="{{route('casos.index')}}">aquí</a> para cargar la información solicitada.
                        </p>
                        <p>
