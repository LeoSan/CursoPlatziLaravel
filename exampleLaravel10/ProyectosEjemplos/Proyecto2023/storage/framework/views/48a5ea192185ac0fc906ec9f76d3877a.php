<div class="col-xs-12 col-md-10 col-sm-4 mb-3">
    <div class="form-group ">
        <label class="form-label mb-2" ><?php echo e(isset($doclabel) && $doclabel ? $doclabel : $item->descripcion); ?></label>
                ...
                <div class="info d-flex align-items-center fw-semibold text-dark pe-2">
                    ...
                    <div class="d-inline">
                        <div  class="break-word d-inline ">
                            <a href="<?php echo e(url('archivos/descarga/'.$item->ruta)); ?>" target="_blank" class="enlace"><?php echo e($item->nombre); ?></a>
                        </div>
                        <p class="fw-normal mb-0">
                            <?php echo e($item->peso); ?>
...
<?php /**PATH C:\laragon\www\sglle-honduras\resources\views/denuncias/fragmentos/documento.blade.php ENDPATH**/ ?>